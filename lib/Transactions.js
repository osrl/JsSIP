...
const debugnict = require('react-native-debug')('JsSIP:NonInviteClientTransaction');
const debugict = require('react-native-debug')('JsSIP:InviteClientTransaction');
const debugact = require('react-native-debug')('JsSIP:AckClientTransaction');
const debugnist = require('react-native-debug')('JsSIP:NonInviteServerTransaction');
const debugist = require('react-native-debug')('JsSIP:InviteServerTransaction');
